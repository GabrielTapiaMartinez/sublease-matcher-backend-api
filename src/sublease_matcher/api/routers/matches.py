...
from ..interfaces.types import ListingDict
...
class EnrichedMatch(MatchOut):
    ...
    target_profile: ListingQueueItem | SeekerQueueItem | None = None
...
def _calculate_recommendation_score(seeker: dict, listing: ListingDict) -> float:
    """
